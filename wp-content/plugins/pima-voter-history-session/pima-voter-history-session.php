<?php
/**
 * Plugin Name: Pima Voter History (Session)
 * Description: Displays paginated voter history (5 rows per page) using the GetVoterHistory API and session-stored voter ID.
 * Version: 1.0.0
 * Author: Local Dev
 */
...
new Pima_Voter_History_Session_Plugin();
