...
*/
    ...
    //this is for staging
    private const VOTER_RECORD_API_URL = 'https://pcro-sqlapi-dev-staging-hsg0b6ceauhgdpbx.westus2-01.azurewebsites.net/api/Database/GetVoterRecord%27;
    private const EARLY_BALLOT_API_URL = 'https://pcro-sqlapi-dev-staging-hsg0b6ceauhgdpbx.westus2-01.azurewebsites.net/api/Database/GetElectionEarlyBallot%27;
    private const VOTER_DISTRICTS_API_URL = 'https://pcro-sqlapi-dev-staging-hsg0b6ceauhgdpbx.westus2-01.azurewebsites.net/api/Database/VoterDistrict%27;
    private const ONLINE_ELECTION_INFO_API_URL = 'https://pcro-sqlapi-dev-staging-hsg0b6ceauhgdpbx.westus2-01.azurewebsites.net/api/Database/GetOnlineElectionInfo%27;
 
    private const TIMEOUT = 25;
    private const SESSION_VOTER_ID_KEY = 'voter_id';
    private const SHORTCODE = 'Voter_Dashboard_Info_Elec_Dist';
   // private const REQUEST_PARAMS_SHORTCODE = 'request_ballot_params';
